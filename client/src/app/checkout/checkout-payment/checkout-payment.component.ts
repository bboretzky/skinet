...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.stripe = Stripe(
      'pk_test_51IE7MVF604B8kH6x4WEqjijexu7yye8TqEio217TgcoT95Q1zNLCxpopj3VyTpw7V42jcwRbcPtgcW4hTeL8cPKQ00UfzYBjre'
    );
  ...
  private async createOrder(basket: IBasket | null) {
    ...
    return this.checkoutService
      .createOrder(orderToCreate as IOrderToCreate)
      .toPromise();
  }
